  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Pagos (Stripe).",
        "Google (opcional, solo si el negocio conecta la integración): Google Calendar, Maps/Geocoding y Google Business Profile. Al crear citas, el negocio puede enviar a Google nombre, teléfono y dirección de sus clientes; el sync a Business Profile usa datos del perfil público del listing, no leads.",
  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        "Payments (Stripe).",
        "Google (optional, only if the business connects the integration): Google Calendar, Maps/Geocoding, and Google Business Profile. When creating appointments, the business may send client name, phone, and address to Google; Business Profile sync uses public listing data only, not leads.",
